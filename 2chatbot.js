...
const displayMessage = (message, type = "bot", isCategory = false) => {
...
const loadNextQuestion = () => {
    ...
    if (currentQuestionIndex === 0) {
        displayMessage(`🧠 Category: ${currentCategory}`, "bot", true);
    }
